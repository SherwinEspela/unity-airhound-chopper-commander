...
private function AutoDetectQuality () {
	...
	else if (UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPhone3GS || UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPodTouch3Gen) {
		currentQuality = Quality.Low;
